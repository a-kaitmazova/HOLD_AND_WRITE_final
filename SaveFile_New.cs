...
{
    public partial class SaveFile_New : Form
    {
        public SaveFile_New()
        {
            InitializeComponent();
            ...
            this.Icon = Properties.Resources.add_list;
        }
        ...
        private void buttonFileSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Вы не выбрали книгу!", "Не выбрали путь сохранения", MessageBoxButtons.OK);
            }
        ...
        {
            if (Directory.GetDirectories(HoldAndWrite.directory + @"\" + HoldAndWrite.foldersNames[(int)HoldAndWrite.MainFolders.Books]).Length > 0)
            { 
